...
#####################Jiang change####################
def mute_body_waves(traces, slope1, const1, slope2, const2, time_scheme, s_coords, r_coords):
    """ Applies tapered mask to record section, muting body waves
    ...
    for ir in range(nr):
        ...
        # apply tapered mask
        traces[ir].data *= mask(slope1, const1, offset, (nt, dt, 0.))
        traces[ir].data *= (1.-mask(slope2, const2, offset, (nt, dt, 0.)))
