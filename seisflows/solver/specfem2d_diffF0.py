...
class specfem2d_diffF0(custom_import('solver', 'base')):
    ...
    def check(self):
        ...
        """
        super(specfem2d_diffF0, self).check()
    ...
    def generate_data(self, **model_kwargs):
        ...
        call_solver(system.mpiexec(), PAR.NPROC, 'bin/xmeshfem2D')
        call_solver(system.mpiexec(), PAR.NPROC, 'bin/xspecfem2D')
    ...
    def initialize_adjoint_traces(self):
        super(specfem2d_diffF0, self).initialize_adjoint_traces()
